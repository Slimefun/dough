...
public class RandomizedSet<T> implements Iterable<T>, Streamable<T> {
	 ...
	 * @param constructor	The Constructor for an implementation of {@link Set}
	 */
	 ...
	 * 
	 * @param constructor	A reference to an Array constructor
	 ...
	 * 
	 * @param obj		The element in this Set
	 * @param weight	The new weight for this element
	 */
	 ...
	 * 
	 * @param random	An instance of {@link Random} to be used.
	 * @return			A random element from this Set
	 */
	 ...
	 * 
	 * @param size		The amount of items to draw from this Set.
