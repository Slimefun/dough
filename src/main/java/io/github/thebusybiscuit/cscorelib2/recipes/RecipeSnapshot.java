...
public class RecipeSnapshot {
	 ...
	 * 
	 * @param plugin	The Plugin running on the Server that serves as the Snapshot's source.
	 */
	 ...
	 * 
	 * @param type		The {@link Material} of your Recipes' outputs.
	 ...
	 * 
	 * @param item		The Result of the Recipes you are looking for
	 ...
	 * 
	 * @param item		The ItemStack input for the Recipes you are looking for.
