...
public class ChestMenu implements Cloneable, Iterable<ItemStack> {
     ...
     *
     * @param plugin
     *            The referencing plugin
     * @param title
     *            The title of the Menu
     * @param dirtyRunnable
     *            A {@link Runnable} that is run when the Inventory was modified
     */
     ...
     * 
     * @param item
     *            The {@link ItemStack} to be checked.
     ...
     * 
     * @param predicate
     *            An {@link ItemStack} {@link Predicate}
     */
    ...
    public void open(Player... players) {
        ...
        setup();
        if (deprecationTask != null)
            deprecationTask.cancel();
     ...
     * 
     * @param slot
     *            The Slot in which to remove the Item
     * @param amount
     ...
     * 
     * @param item
     *            The Item that shall be added to the Inventory
     * @param slots
     *            The Slots in which to try pushing it.
     ...
     * 
     * @param ticks
     *            How long to wait after the last Person closed the Inventory
     * @param runnable
     *            The Runnable to run when this happens
     */
